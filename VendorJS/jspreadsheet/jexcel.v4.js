...
;(function (global, factory) {
    ...
    var jexcel = (function(el, options) {
        ...
        */
	    ...
	    // Custom classes
	    if (obj.options.columns[i].classes)
		td.className += " "+obj.options.columns[i].classes;
	    ...
	    // Custom classes
	    if (obj.options.columns[colNumber].classes)
		obj.headers[colNumber].className += " "+obj.options.columns[colNumber].classes;
