        ...
        <h2 class="panel-title">
          <!--<a role="button" data-toggle="collapse" data-parent="#accordion" href="#{$collapseId}" aria-expanded="true" aria-controls="{$collapseId}">-->
            ...
            <xsl:call-template name="getPublicationLink">
              ...
              <xsl:with-param name="title">Voir toutes les démarches disponibles dans ce dossier</xsl:with-param>
        ...
        <div class="panel-body">
          <ul class="spPublicationNoeud">
            ...
            <li class="more">
              <xsl:call-template name="getPublicationLink">
                <xsl:with-param name="href"><xsl:value-of select="@ID"/></xsl:with-param>
                <xsl:with-param name="title">Toutes les démarches du dossier : <xsl:value-of select="Titre"/></xsl:with-param>
                <xsl:with-param name="text"><span class="glyphicon glyphicon-plus-sign"></span> Autre</xsl:with-param>
              </xsl:call-template>
            </li>
          </ul>
        </div>	
