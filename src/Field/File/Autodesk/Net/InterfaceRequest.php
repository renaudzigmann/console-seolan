 ...
 * => todo : extends \Seolan\Core\JsonClient\Request ou corriger autodesk
 */
...
class InterfaceRequest {  
  ...
  public function doRequest($type, $url, $params = array(), $headers) {
    ...
    \Seolan\Core\Logs::notice(__METHOD__.' params:'.var_export($paramsRaw, true));
    \Seolan\Core\Logs::notice(__METHOD__.' params:'.var_export($params, true));
    ...
    curl_close($s);
    return new InterfaceResponse($status,$data,$responseHeaders);
  }
  /**
