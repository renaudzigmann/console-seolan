...
/*
* D'après
* https://github.com/aphania/axepta-access/blob/master/axepta.php
*/
...
class PayPage {
	...
	public function shaCompose(array $parameters)
  {
    ...
    if ($this->debug) {
      debug(__METHOD__.' _____ sha string ='.$shaString.PHP_EOL);
      debug(__METHOD__.' _____ hmacKey ='.$this->hmacKey.PHP_EOL);
    }
