 ...
 * --------------------------------------------------------------------
 */
if (typeof(daterangepicker_locale) == 'undefined')
...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		...
		prevLinkText: 'Prev',
		doneButtonText: 'Done',
		minDate: Date.parse('-15years'), //earliest date allowed
		maxDate: Date.parse('+15years'), //latest date allowed
	...
	}, daterangepicker_locale, settings);
	...
	jQuery.fn.clickActions = function(rp, rpPickers, doneBtn){
		...
		if(jQuery(this).is('.ui-daterangepicker-specificDate')){
			...
			rp.find('.range-start').saveDateToData().datepicker('setDate', options.minDate).hide(400);
			...
			rp.find('.range-start').restoreDateFromData().show(400);
			rp.find('.range-end').saveDateToData().datepicker('setDate', options.maxDate).hide(400);
			setTimeout(function(){doneBtn.fadeIn();}, 400);
		}
