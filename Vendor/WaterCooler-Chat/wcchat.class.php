...
class WcChat {
     ...
     * @return void
     */
    public function initIncPath() {

        self::$includeDirServer = __DIR__ . '/';
    
        include_once self::$includeDirServer . 'settings.php';
        include_once self::$includeDirServer . 'includes/classes/wcuser.class.php';
        include_once self::$includeDirServer . 'includes/classes/wcroom.class.php';
        include_once self::$includeDirServer . 'includes/classes/wcutils.class.php';
        include_once self::$includeDirServer . 'includes/classes/wcutils.file.class.php';
        include_once self::$includeDirServer . 'includes/classes/wcutils.gui.class.php';
        include_once self::$includeDirServer . 'includes/classes/wcutils.img.class.php';
        include_once self::$includeDirServer . 'includes/classes/wcutils.pgc.class.php';
        include_once self::$includeDirServer . 'includes/classes/wcutils.time.class.php';
        
        self::$wcPrefix = 'WaterCoolerChat';//strtoupper(dechex(crc32(self::$includeDirServer)));
