...
<div class="msg{PM_SUFIX} {CLASSES}">
    {UPDATED_NOTE}
    {PM_TAG}
...
$templates['wcchat.posts.normal.edit_tag.bt'] = '';
...
$templates['wcchat.posts.hide_icon'] = '';
...
$templates['wcchat.posts.new_msg_separator'] = '<div id="wc_new_msg" class="new_msg"></div>';
