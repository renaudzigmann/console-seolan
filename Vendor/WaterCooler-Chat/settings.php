...
define('INCLUDE_DIR', TZR_SHARE_SCRIPTS.'/chat-ajax.php?query=');
...
define('REFRESH_DELAY_IDLE', 60000);
...
define('PERM_ROOM_C', 'MMOD CUSER USER');
define('PERM_ROOM_E', 'MMOD CUSER USER');
define('PERM_ROOM_D', 'MMOD CUSER USER');
...
define('PERM_ATTACH_UPL', 'MMOD MOD');
...
define('DATA_DIR', $_SERVER['DOCUMENT_ROOT'] . '../var/chat/data/');
