...
function extractDateTime($data, $property, $field) {
	...
	preg_match ('/([0-9]{4})([0-9]{2})([0-9]{2})T{0,1}([0-9]{0,2})([0-9]{0,2})([0-9]{0,2})/', $data, $regs);
	...
	$server_offset_tmp = chooseOffset($unixtime, ($phpiCal_config?$phpiCal_config->timezone:NULL));
	if (isset($tz_dt)) {
